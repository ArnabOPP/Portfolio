  ...
  return {
    ...
    contact: {
      ...
      social: {
        GitHub: {
          name: "GitHub",
          url: github?.url || "https://github.com/ArnabOPP",
          icon: Icons.github,
          navbar: true,
        },
        LinkedIn: {
          name: "LinkedIn",
          url: linkedin?.url || "https://www.linkedin.com/in/arnab-chatterjee-prsnl/",
          icon: Icons.linkedin,
          navbar: true,
        },
        X: {
          name: "X",
          url: twitter?.url || "https://x.com/ARNABintheCHAT",
          icon: Icons.x,
          navbar: false,
        },
        Instagram: {
          name: "Instagram",
          url: instagram?.url || "https://www.instagram.com/mainly_arnab__/",
