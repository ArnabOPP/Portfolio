                ...
                {sections.map((section, index) => (
                    ...
                    >
                        <div className={cn(
                            ...
                            <ImageCard
                                section={section}
                                opacityStyle={opacityContents[index]}
                                scaleStyle={scales[index]}
                                yStyle={imageY[index]}
                            />
                        </div>
                    </div>
...
function ImageCard({ section, opacityStyle, scaleStyle, yStyle }: {
    section: { title: string; imageUrl: string; reverse: boolean };
    opacityStyle: any;
    scaleStyle: any;
    yStyle: any;
}) {
    ...
    return (
        <motion.div
            style={{ opacity: opacityStyle, scale: scaleStyle, y: yStyle }}
            className={cn(
