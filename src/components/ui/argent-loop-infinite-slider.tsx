...
const PROJECT_DATA: ProjectData[] = [
  {
    title: "Lightswind UI Library",
    image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=2034&auto=format&fit=crop",
    category: "Open Source & UI",
    year: "2025",
    description: "Production-ready React component library for modern web apps.",
    slug: "lightswind-ui-library"
  },
  {
    ...
    year: "2025",
    description: "AI-powered ESG compliance auditing with LangChain & Ollama.",
    slug: "esg-auditor-2"
  },
  {
    ...
    year: "2025",
    description: "Smart attendance management platform with real-time analytics.",
    slug: "attendinn-system"
  },
  {
    title: "FPV Drone Platform",
    image: "https://images.unsplash.com/photo-1473968512647-3e447244af8f?q=80&w=2070&auto=format&fit=crop",
    category: "IoT & Embedded",
    year: "2026",
    description: "Custom FPV drone with ESP32 telemetry and live monitoring.",
  ...
  },
  {
    ...
    year: "2025",
    description: "Cross-platform fitness tracking app built with Flutter.",
    slug: "jkfitness-app"
  },
];
            ...
            <div className="h-[200px] w-full flex items-center justify-center pt-10">
              ...
              >
                <div className="flex items-center gap-4 pointer-events-auto">
                  <a 
                    href="https://github.com/ArnabOPP"
                    target="_blank" 
