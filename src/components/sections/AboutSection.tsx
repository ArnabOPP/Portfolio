...
import { HorizontalProjectCarousel } from "@/components/ui/horizontal-project-carousel";
...
const showcaseMembers = [
    // 1. IEEE SIGHT IEM Student Chapter
    ...portfolioData.experiences.filter(exp => exp.id === 'prof-1').map(exp => ({
        ...
        image: "/gallery/FotoSC1.jpeg",
        social: exp.externalLink ? { website: exp.externalLink } : undefined
    })),
    // 2. ENGImitra
    ...portfolioData.experiences.filter(exp => exp.id === 'prof-founder').map(exp => ({
        id: exp.id,
        name: exp.company,
        role: exp.position,
        description: exp.description,
        period: "April 2026 - Present",
        image: "/gallery/FotoSC2.jpeg",
        social: exp.externalLink ? { website: exp.externalLink } : undefined
    })),
    // 3. Lions Club International
    ...portfolioData.experiences.filter(exp => exp.id === 'prof-lions').map(exp => ({
        id: exp.id,
        name: exp.company,
        role: exp.position,
        description: exp.description,
        period: "December 2025 - Present",
        image: "/gallery/FotoSC3.jpeg",
        social: exp.externalLink ? { website: exp.externalLink } : undefined
    })),
    // 4. Prodigy InfoTech
    ...portfolioData.experiences.filter(exp => exp.id === 'prof-prodigy').map(exp => ({
        id: exp.id,
        name: exp.company,
        role: exp.position,
        description: exp.description,
        period: "June 2025 - Present",
        image: "/gallery/FotoSC4.jpeg",
        social: exp.externalLink ? { website: exp.externalLink } : undefined
    })),
    // 5. Scaler School of Technology
    ...portfolioData.experiences.filter(exp => exp.id === 'prof-scaler').map(exp => ({
        id: exp.id,
        name: exp.company,
        role: exp.position,
        description: exp.description,
        period: "June 2024 - September 2024",
        image: "/gallery/FotoSC5.jpeg",
        social: exp.externalLink ? { website: exp.externalLink } : undefined
    })),
    // 6. View more
    {
        ...
        <div className="w-full max-w-[1650px] mx-auto px-6 py-6 flex justify-center items-center">
            ...
            <div className="relative w-full bg-white dark:bg-black border border-red-600/20 dark:border-red-600/40 p-6 md:p-12 lg:p-16 overflow-hidden group shadow-xl dark:shadow-2xl transition-colors duration-500">
                ...
                <div className="relative z-10">
                    ...
                    >
                        <h2 className="text-[32px] sm:text-[48px] md:text-[64px] lg:text-[76px] xl:text-[88px] font-bold tracking-tight leading-[1.1] text-zinc-900 dark:text-white transition-colors">
