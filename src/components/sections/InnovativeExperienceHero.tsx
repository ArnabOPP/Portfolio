...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        { label: 'IEM Saltlake', description: 'B.Tech CSE (AIML) – Institute of Engineering and Management, Saltlake.', orbitIndex: 0, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=400&auto=format&fit=crop" },
        { label: 'Google Cloud', description: 'Google Cloud GenAI Academy Graduate – Generative AI on GCP.', orbitIndex: 1, position: 0.25, imageUrl: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=400&auto=format&fit=crop" },
        { label: 'Lightswind OSS', description: 'Open-source contributor – React UI component library.', orbitIndex: 0, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1527689368864-3a821dbccc34?q=80&w=400&auto=format&fit=crop" },
        { label: 'PHYCATHON', description: 'Hackathon finalist – Physics-based engineering challenge.', orbitIndex: 1, position: 0.65, imageUrl: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=400&auto=format&fit=crop" },
        { label: 'AI/ML Research', description: 'Independent study in machine learning and neural networks.', orbitIndex: 0, position: 0.85, imageUrl: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=400&auto=format&fit=crop" },
        { label: 'IoT & Embedded', description: 'Self-taught ESP32 / Arduino hardware programming.', orbitIndex: 1, position: 0.05, imageUrl: "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=400&auto=format&fit=crop" },
    ],
    journey: [
        { label: 'Co-Founder', description: 'ENGImitra – Co-founded an engineering consulting startup.', orbitIndex: 0, position: 0.15, imageUrl: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=400&auto=format&fit=crop" },
        { label: 'Open Source', description: 'Lightswind – Contributing to React UI library for developers.', orbitIndex: 1, position: 0.35, imageUrl: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=400&auto=format&fit=crop" },
        { label: 'Hackathon Lead', description: 'PHYCATHON – Led team in national physics hackathon.', orbitIndex: 0, position: 0.55, imageUrl: "https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=400&auto=format&fit=crop" },
        { label: 'Cloud Training', description: 'Google Cloud Academy – AI/ML on cloud infrastructure.', orbitIndex: 1, position: 0.75, imageUrl: "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?q=80&w=400&auto=format&fit=crop" },
        { label: 'Full Stack Dev', description: 'Building end-to-end web applications with Next.js & Node.js.', orbitIndex: 0, position: 0.9, imageUrl: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=400&auto=format&fit=crop" },
        { label: 'Mobile Dev', description: 'Flutter-based cross-platform mobile app development.', orbitIndex: 1, position: 0.02, imageUrl: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=400&auto=format&fit=crop" },
    ],
    experience: [
        { label: 'AI/ML Engineer', description: 'Building LLM pipelines with LangChain, Ollama, and Python.', orbitIndex: 0, position: 0.2, imageUrl: "https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=400&auto=format&fit=crop" },
        { label: 'Full Stack Eng.', description: 'Next.js, TypeScript, Tailwind – scalable web platforms.', orbitIndex: 1, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1454165833911-5421db635848?q=80&w=400&auto=format&fit=crop" },
        { label: 'IoT Engineering', description: 'FPV Drone & ESP32 telemetry with live data dashboards.', orbitIndex: 0, position: 0.6, imageUrl: "https://images.unsplash.com/photo-1473968512647-3e447244af8f?q=80&w=400&auto=format&fit=crop" },
        { label: 'UI/UX Design', description: 'Designing accessible interfaces and component libraries.', orbitIndex: 1, position: 0.8, imageUrl: "https://images.unsplash.com/photo-1518433278988-c7bc488ce92d?q=80&w=400&auto=format&fit=crop" },
        { label: 'Data Science', description: 'ESG Auditor – AI-powered sustainability data analysis.', orbitIndex: 0, position: 0.95, imageUrl: "https://images.unsplash.com/photo-1504711434969-e33886168f5c?q=80&w=400&auto=format&fit=crop" },
        { label: 'Co-Founder', description: 'ENGImitra – Engineering consulting and product development.', orbitIndex: 1, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=400&auto=format&fit=crop" },
    ]
};
